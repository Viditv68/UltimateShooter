...
bool AShooterCharacter::GetBeamEndLocation(const FVector& MuzzleSocketLocation, FVector& OutBeamLocation)
{
	...
	const FVector StarToEnd{ OutBeamLocation - MuzzleSocketLocation };
	const FVector WeaponTraceEnd{ MuzzleSocketLocation + StarToEnd * 1.25f };
...
bool AShooterCharacter::TraceUnderCrosshairs(FHitResult& OutHitResult, FVector& OutHitLocation )
{
	...
	if (bScreenToWorld)
	{
		//trace from crosshair worldlocation outward
...
void AShooterCharacter::TraceForItems()
{
	...
	else if(TraceHitItemLastFrame != NULL)
	{
...
{
	//check the TSUbclass of variables
...
void AShooterCharacter::EquipWeapon(AWeapon* WeaponToEquip)
{
	if (WeaponToEquip)
	{
		...
		//setcollision box to ignore all collision channels
...
void AShooterCharacter::Tick(float DeltaTime)
{
	...
	//check overlapped item count and then trace for items 
	TraceForItems();
}

...
protected:
	...
	//drops currently equipped weapon and equipes trace hit item
...
private:
	...
	//Set this in bleprint for the default class
	...
	//Distacne outward from the camera for the interp destination
